...
const CHAT: Record<string, { ja: string; en: string }> = {
  ...
  'Chuyển sang Bước 3: Thiết kế': { ja: 'ステップ3へ: 設計', en: 'Go to Step 3: Design' },
  'Chuyển sang Bước 4: Sản xuất': { ja: 'ステップ4へ: 生産', en: 'Go to Step 4: Production' },
  ...
  'Giải thích sơ đồ đấu dây điện': { ja: '配線図の説明', en: 'Explain the wiring diagram' },
  'Giải thích logic điều khiển PLC': { ja: 'PLC制御ロジックの説明', en: 'Explain the PLC control logic' },
  'Thông số kỹ thuật màn hình HMI': { ja: 'HMI画面の技術仕様', en: 'HMI screen technical specs' },
  'Danh sách I/O điểm vào/ra': { ja: 'I/Oポイント一覧', en: 'List of I/O points' },
  ...
  'Đã chuyển sang Bước 3: Thiết kế. Bảng đặc tả specs đã hiển thị ở bên trái.': { ja: 'ステップ3「設計」に移動しました。仕様書を左側に表示しています。', en: 'Moved to Step 3: Design. The specs sheet is shown on the left.' },
  'Đã chuyển sang Bước 4: Sản xuất. AI đã sinh bản vẽ CAD và Structured Text.': { ja: 'ステップ4「生産」に移動しました。AI が CAD 図面と Structured Text を生成しました。', en: 'Moved to Step 4: Production. The AI generated the CAD drawing and Structured Text.' },
  ...
  'Đã chuyển sang Bước 3: Thiết kế. Đang tiến hành tăng số lượng Cảm biến quang điện (Photoelectric Sensor) thêm 2 cái.': { ja: 'ステップ3「設計」に移動しました。光電センサーの数量を2個追加しています。', en: 'Moved to Step 3: Design. Increasing the photoelectric sensor quantity by 2.' },
  'Đã chuyển sang Bước 3: Thiết kế. Đang thay đổi cấu hình màn hình HMI sang GOT2000 10-inch và áp dụng giá trị mặc định của Master Data.': { ja: 'ステップ3「設計」に移動しました。HMI 画面構成を GOT2000 10インチに変更し、マスターデータの既定値を適用しています。', en: 'Moved to Step 3: Design. Changing the HMI screen to GOT2000 10-inch and applying Master Data defaults.' },
  'Đã chuyển sang Bước 3: Thiết kế. Đang tiến hành bổ sung thêm 1 trục Servo Motor (MR-J5-40A) cho cơ cấu băng tải nạp phôi phụ.': { ja: 'ステップ3「設計」に移動しました。補助ワーク供給コンベヤ用にサーボモーター軸（MR-J5-40A）を1つ追加しています。', en: 'Moved to Step 3: Design. Adding 1 servo motor axis (MR-J5-40A) for the auxiliary feed conveyor.' },
